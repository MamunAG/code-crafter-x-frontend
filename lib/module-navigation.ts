    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "Material Group Entry",
            href: "/app-config/data/material-groups",
            permissionMenuName: "Material Group Entry",
          },
          {
    ...
    groups: [
      {
        ...
        items: [
          ...
          {
            label: "Shift Setup",
            href: "/hr-payroll/shifts",
            description: "Configure employee working hours and shift rules.",
            permissionMenuName: "Shift Setup",
          },
          {
            label: "Roster Management",
            href: "/hr-payroll/rosters",
            description: "Assign effective-dated shifts to employees.",
            permissionMenuName: "Roster Management",
          },
          {
          ...
          },
          {
            ...
            description: "Manage employee loans and payroll deductions.",
            permissionMenuName: "Loan Management",
          },
          {
            label: "Statutory Rules",
            href: "/hr-payroll/statutory-rules",
            description: "Review effective-dated payroll policy packs.",
            permissionMenuName: "Statutory Rules",
          },
          {
            label: "Payroll Processing",
            href: "/hr-payroll/payroll-runs",
            description: "Calculate, review, approve, and lock payroll runs.",
            permissionMenuName: "Payroll Processing",
          },
          {
            label: "HR Reports",
            href: "/hr-payroll/reports",
            description: "Preview and export HR and payroll reports.",
            permissionMenuName: "HR Reports",
          },
          {
            label: "HR Imports",
            href: "/hr-payroll/imports",
