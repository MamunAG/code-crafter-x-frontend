...
export function PayrollEntryForm({
  ...
  return (
    <HrFormDialog
      ...
      description="Define a unique pay period and create its immutable payroll workflow record."
      values={values}
      ...
      fields={[
        ...
        },
        {
          ...
          kind: "select",
          required: true,
          options: ["WEEKLY", "BIWEEKLY", "SEMIMONTHLY", "MONTHLY"].map((value) => ({
            value,
            label: value,
          })),
        },
        {
          ...
          kind: "select",
          required: true,
          options: ["REGULAR", "BONUS", "ARREARS", "ADJUSTMENT", "FINAL_SETTLEMENT"].map(
        ...
        {
          name: "rulePackId",
          label: "Statutory rule pack",
          kind: "select",
          options: [{ value: "__none__", label: "Use organization default" }, ...rulePacks],
        },
