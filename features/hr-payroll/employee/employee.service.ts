...
function buildEmployeePayload(payload: EmployeeFormValues) {
  return {
    ...
    employmentTypeId: optionalString(payload.employmentTypeId),
    gradeId: optionalString(payload.gradeId),
    payGroupId: optionalString(payload.payGroupId),
    workLocationId: optionalString(payload.workLocationId),
    ...
    probationEndDate: optionalString(payload.probationEndDate),
    confirmationDate: optionalString(payload.confirmationDate),
    contractEndDate: optionalString(payload.contractEndDate),
    separationDate: optionalString(payload.separationDate),
