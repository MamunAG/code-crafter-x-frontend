      ...
      <CardContent className="p-3 sm:p-0 sm:px-2">
        ...
        >
          ...
          <div className="min-w-0 space-y-1">
            ...
            <Input id="filterMaterialDescription" value={filters.description} className="h-7 rounded-md px-2 text-xs" onChange={(event) => onFilterChange({ ...filters, description: event.target.value })} placeholder="Input description" />
          </div>
          <div className="min-w-0 space-y-1">
