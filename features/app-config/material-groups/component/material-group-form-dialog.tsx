...
import type { MaterialGroupFormValues } from "../material-group.types"
...
type MaterialGroupFormDialogProps = {
  ...
  submitting: boolean
  error: string
  mode: MaterialGroupEditorMode
  initialValues: MaterialGroupFormValues
...
export function MaterialGroupFormDialog({
  ...
  const title =
    mode === "create" ? "Create material group" : "Edit material group"
  const description =
    mode === "create"
      ? "Add a material group master record."
      : "Update the selected material group master record."

  useEffect(() => {
    if (open) setDraft(initialValues)
  }, [initialValues, open])

  function update<K extends keyof MaterialGroupFormValues>(
    key: K,
    value: MaterialGroupFormValues[K]
  ) {
            ...
            <div className="space-y-4 px-6 py-5">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Input material group name"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Input material group description"
                  disabled={loading || submitting}
                />
              </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Active material groups can be selected in material records.
                    </p>
                  </div>
                  <Switch
          ...
          <div className="border-t border-slate-200/70 px-6 py-4 dark:border-white/10">
            <DialogFooter>
              ...
              >
                ...
                {mode === "create" ? "Save material group" : "Save changes"}
              </Button>
            </DialogFooter>
          </div>
        </form>
